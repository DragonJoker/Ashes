...
*/
#ifndef ___Ashes_AttachmentStoreOp_HPP___
#define ___Ashes_AttachmentStoreOp_HPP___
#pragma once
...
namespace ashes
{
	...
	*/
		...
		: uint32_t
	{
		...
		*	For attachments with a depth/stencil format, this uses the access type ashes::AccessFlag::eDepthStencilAttachmentWrite.
		*	For attachments with a color format, this uses the access type ashes::AccessFlag::eColourAttachmentWrite.
		*\~french
		*\brief
		...
		*	Pour les attaches ayant un format profondeur/stencil, cela utilise le type d'accès ashes::AccessFlag::eDepthStencilAttachmentWrite.
		*	Pour les attaches ayant un format couleur, cela utilise le type d'accès ashes::AccessFlag::eColourAttachmentWrite.
		*/
		eDontCare,
	};
	/**
