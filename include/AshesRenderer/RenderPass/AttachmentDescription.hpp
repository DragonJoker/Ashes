...
*/
#ifndef ___Ashes_RenderPassAttachment_HPP___
#define ___Ashes_RenderPassAttachment_HPP___
#pragma once
...
namespace ashes
{
	...
	*/
	struct AttachmentDescription
	{
		...
		*\~english
		*\brief
		*	The number of samples of the image as defined in ashes::SampleCountFlag.
		*\~french
		*\brief
		*	Le nombre d'échantillons de l'image tel que défini dans ashes::SampleCountFlag.
		*/
