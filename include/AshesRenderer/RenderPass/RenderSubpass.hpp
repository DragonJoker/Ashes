...
*/
#ifndef ___Ashes_RenderSubpass_HPP___
#define ___Ashes_RenderSubpass_HPP___
#pragma once

#include "AshesRenderer/RenderPass/AttachmentReference.hpp"
#include "AshesRenderer/RenderPass/RenderSubpassState.hpp"
#include "AshesRenderer/RenderPass/SubpassDescription.hpp"
...
namespace ashes
{
	...
	*/
	...
	public:
		...
		*	At the end of each subpass, multisample resolve operations read the subpass’s color attachments, and resolve the samples for each pixel to the same pixel location in the corresponding resolve attachments, unless the resolve attachment index is ashes::AttachmentUnused.
		...
		*	Setting the attachment index to ashes::AttachmentUnused or leaving this pointer as \p nullptr indicates that no depth/stencil attachment will be used in the subpass.
		...
		*	A la fin de chaque sous-passe, les opérations de résolution de multi-échantillon lisent les attaches couleur de la sous-passe, et résolvent les échantillons pour chaque pixel à la même position de que le pixel dans l'attache de résolution, à moins que l'indice de l'attache de résolution soit ashes::AttachmentUnused.
		...
		*	Si ce pointeur est \p nullptr, ou si l'indice de l'attache vaut ashes::AttachmentUnused, alors aucune attache de profondeur/stencil ne sera utilisée dans la sous-passe.
		*\param[in] reserveAttaches
