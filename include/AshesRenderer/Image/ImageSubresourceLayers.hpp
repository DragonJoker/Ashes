...
*/
#ifndef ___Ashes_ImageSubresourceLayers_HPP___
#define ___Ashes_ImageSubresourceLayers_HPP___
#pragma once
...
namespace ashes
{
	...
	*/
	struct ImageSubresourceLayers
	{
		...
		*\~english
		*\brief
		*	Combination of ashes::ImageAspectFlag, selecting the color, depth and/or stencil aspects to be copied.
		*\~french
		*\brief
		*	Combinaison de ashes::ImageAspectFlag, sélectionnant les aspects à copier, parmi couleur, profondeur et/ou stencil.
		*/
