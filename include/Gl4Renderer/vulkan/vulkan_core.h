...
#define VK_DEFINE_HANDLE(object) typedef struct object##_T* Vk##object;
...
VK_DEFINE_HANDLE(Semaphore)
VK_DEFINE_HANDLE(CommandBuffer)
VK_DEFINE_HANDLE(Fence)
VK_DEFINE_HANDLE(DeviceMemory)
VK_DEFINE_HANDLE(Buffer)
VK_DEFINE_HANDLE(Image)
VK_DEFINE_HANDLE(Event)
VK_DEFINE_HANDLE(QueryPool)
VK_DEFINE_HANDLE(BufferView)
VK_DEFINE_HANDLE(ImageView)
VK_DEFINE_HANDLE(ShaderModule)
VK_DEFINE_HANDLE(PipelineCache)
VK_DEFINE_HANDLE(PipelineLayout)
VK_DEFINE_HANDLE(RenderPass)
VK_DEFINE_HANDLE(Pipeline)
VK_DEFINE_HANDLE(DescriptorSetLayout)
VK_DEFINE_HANDLE(Sampler)
VK_DEFINE_HANDLE(DescriptorPool)
VK_DEFINE_HANDLE(DescriptorSet)
VK_DEFINE_HANDLE(Framebuffer)
VK_DEFINE_HANDLE(CommandPool)
...
VK_DEFINE_HANDLE(SamplerYcbcrConversion)
VK_DEFINE_HANDLE(DescriptorUpdateTemplate)
...
VK_DEFINE_HANDLE(DisplayKHR)
VK_DEFINE_HANDLE(DisplayModeKHR)
...
VK_DEFINE_HANDLE(DebugReportCallbackEXT)
...
VK_DEFINE_HANDLE(ObjectTableNVX)
VK_DEFINE_HANDLE(IndirectCommandsLayoutNVX)
...
VK_DEFINE_HANDLE(DebugUtilsMessengerEXT)
...
VK_DEFINE_HANDLE(ValidationCacheEXT)
