	...
	*/
	...
	private:
		...
		static inline std::string subDump( VkPipelineDynamicStateCreateInfo const & value, std::string const & tabs )
		{
			...
			dump << tabs << "\t" << "pDynamicStateEnables: " << std::endl << subDump( value.pDynamicStates, value.dynamicStateCount, tabs + "\t" ) << std::endl;
			dump << tabs << "}" << std::endl;
			return dump.str();
		}
		...
		static inline std::string subDump( VkGraphicsPipelineCreateInfo const & value, std::string const & tabs )
		{
			...
			dump << tabs << "\t" << "pDynamicStateEnable: " << std::endl << subDump( value.pDynamicState, tabs + "\t" ) << std::endl;
