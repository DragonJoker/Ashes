...
*	Sylvain Doremus
*/
#ifndef ___Utils_PlaneEquation_HPP___
#define ___Utils_PlaneEquation_HPP___
#pragma once
...
namespace utils
{
	...
	*/
	...
	public:
		...
		*/
		PlaneEquation( Vec3 const & normal
			, Vec3 const & point );
		/**
		*\brief
		...
		*/
		Vec3 project( Vec3 const & point )const;
		/**
		*\brief
