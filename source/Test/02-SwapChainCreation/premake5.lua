project "Test-02-SwapChainCreation"

currentSourceDir = path.join( sourceDir, "Test", "02-SwapChainCreation" )
currentBinaryDir = path.join( binaryDir, "Test", "02-SwapChainCreation" )
