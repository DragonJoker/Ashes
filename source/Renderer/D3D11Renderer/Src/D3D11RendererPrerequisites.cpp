...
namespace d3d11_renderer
{
	...
	{
		static std::map< HRESULT, std::string > Errors
		{
			...
			{ DXGI_ERROR_INVALID_CALL, "The method call is invalid.For example, a method's parameter may not be a valid pointer." },
