...
*/
#include "D3D11GenerateMipsCommand.hpp"
...
namespace d3d11_renderer
{
	namespace
	{
		renderer::ImageViewCreateInfo getCreateInfos( Texture const & texture )
		{
			renderer::ImageViewCreateInfo result;
			result.viewType = renderer::TextureViewType( texture.getType() );
