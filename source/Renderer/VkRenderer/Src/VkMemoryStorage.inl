...
namespace vk_renderer
{
		...
		: m_device{ device }
	{
		...
		auto res = AllocateMemory( m_device, &allocateInfo, nullptr, &m_memory );
	...
	{
		FreeMemory( m_device, m_memory, nullptr );
	}
		...
		, bool modified )const
	{
		if ( modified )
		{
			...
			auto res = FlushMappedMemoryRanges( m_device, 1, &flushRange );
