...
namespace ashes::gl
{
	...
	private:
		...
		void doGetValue( ContextLock & context, GlGetParameter name, int32_t & value )const;
		void doGetValue( ContextLock & context, GlGetParameter name, uint32_t & value )const;
		void doGetValues( ContextLock & context, GlGetParameter name, int32_t( &value )[2] )const;
		void doGetValues( ContextLock & context, GlGetParameter name, uint32_t( &value )[2] )const;
		void doGetValues( ContextLock & context, GlGetParameter name, int32_t( &value )[3] )const;
		void doGetValues( ContextLock & context, GlGetParameter name, uint32_t( &value )[3] )const;
		void doGetValues( ContextLock & context, GlGetParameter name, int32_t( &value )[4] )const;
		void doGetValues( ContextLock & context, GlGetParameter name, uint32_t( &value )[4] )const;
		void doGetValuesI( ContextLock & context, GlGetParameter name, int32_t( &value )[2] )const;
		void doGetValuesI( ContextLock & context, GlGetParameter name, uint32_t( &value )[2] )const;
		void doGetValuesI( ContextLock & context, GlGetParameter name, int32_t( &value )[3] )const;
		void doGetValuesI( ContextLock & context, GlGetParameter name, uint32_t( &value )[3] )const;
		void doGetValue( ContextLock & context, GlGetParameter name, int64_t & value )const;
		void doGetValue( ContextLock & context, GlGetParameter name, uint64_t & value )const;
		void doGetValues( ContextLock & context, GlGetParameter name, int64_t( &value )[2] )const;
		void doGetValues( ContextLock & context, GlGetParameter name, uint64_t( &value )[2] )const;
		void doGetValues( ContextLock & context, GlGetParameter name, int64_t( &value )[3] )const;
		void doGetValues( ContextLock & context, GlGetParameter name, uint64_t( &value )[3] )const;
		void doGetValuesI( ContextLock & context, GlGetParameter name, int64_t( &value )[2] )const;
		void doGetValuesI( ContextLock & context, GlGetParameter name, uint64_t( &value )[2] )const;
		void doGetValuesI( ContextLock & context, GlGetParameter name, int64_t( &value )[3] )const;
		void doGetValuesI( ContextLock & context, GlGetParameter name, uint64_t( &value )[3] )const;
		void doGetValue( ContextLock & context, GlGetParameter name, float & value )const;
		void doGetValues( ContextLock & context, GlGetParameter name, float( &value )[2] )const;
		void doGetValues( ContextLock & context, GlGetParameter name, float( &value )[3] )const;
		void doGetValuesI( ContextLock & context, GlGetParameter name, float( &value )[2] )const;
		void doGetValuesI( ContextLock & context, GlGetParameter name, float( &value )[3] )const;
