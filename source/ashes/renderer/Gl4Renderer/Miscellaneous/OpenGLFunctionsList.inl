...
GL_LIB_FUNCTION( BindProgramPipeline )
...
GL_LIB_FUNCTION( DeleteProgramPipelines )
...
GL_LIB_FUNCTION( DepthRangeArrayv )
...
GL_LIB_FUNCTION( GenProgramPipelines )
...
GL_LIB_FUNCTION( GetFloati_v )
GL_LIB_FUNCTION( GetIntegeri_v )
GL_LIB_FUNCTION( GetInteger64i_v )
...
GL_LIB_FUNCTION( ProgramUniform1iv )
GL_LIB_FUNCTION( ProgramUniform1uiv )
GL_LIB_FUNCTION( ProgramUniform2fv )
GL_LIB_FUNCTION( ProgramUniform2iv )
GL_LIB_FUNCTION( ProgramUniform2uiv )
GL_LIB_FUNCTION( ProgramUniform3fv )
GL_LIB_FUNCTION( ProgramUniform3iv )
GL_LIB_FUNCTION( ProgramUniform3uiv )
GL_LIB_FUNCTION( ProgramUniform4fv )
GL_LIB_FUNCTION( ProgramUniform4iv )
GL_LIB_FUNCTION( ProgramUniform4uiv )
GL_LIB_FUNCTION( ProgramUniformMatrix2fv )
GL_LIB_FUNCTION( ProgramUniformMatrix3fv )
GL_LIB_FUNCTION( ProgramUniformMatrix4fv )
