...
namespace ashes::gl3
{
	...
	using PFN_glTexBuffer = void ( GLAPIENTRY * )( GLenum target, GLenum internalformat, GLuint buffer );
	...
	using PFN_glTexEnvfv = void ( GLAPIENTRY * )( GLenum target, GLenum pname, const GLfloat * params );
	...
	using PFN_glTexParameterf = void( GLAPIENTRY * )( GLenum target, GLenum pname, GLfloat param );
