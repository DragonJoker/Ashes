...
#pragma region VK_KHR_get_display_properties2
	...
	{
		return g_library.getSelectedDesc().functions.GetPhysicalDeviceDisplayProperties2KHR( physicalDevice, pPropertyCount, pProperties );
	}
	...
	{
		return g_library.getSelectedDesc().functions.GetPhysicalDeviceDisplayPlaneProperties2KHR( physicalDevice, pPropertyCount, pProperties );
	}
	...
	{
		return g_library.getSelectedDesc().functions.GetDisplayModeProperties2KHR( physicalDevice, display, pPropertyCount, pProperties );
	}
	...
	{
		return g_library.getSelectedDesc().functions.GetDisplayPlaneCapabilities2KHR( physicalDevice, pDisplayPlaneInfo, pCapabilities );
	}
