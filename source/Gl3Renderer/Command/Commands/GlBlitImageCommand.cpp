...
namespace gl_renderer
{
	...
	BlitImageCommand::BlitImageCommand( Device const & device
		...
		, m_srcTarget{ checkFlag( m_srcTexture.getCreateFlags(), ashes::ImageCreateFlag::eCubeCompatible ) ? GL_TEXTURE_CUBE_POSITIVE_X : GL_TEXTURE_2D }
		, m_dstTarget{ checkFlag( m_dstTexture.getCreateFlags(), ashes::ImageCreateFlag::eCubeCompatible ) ? GL_TEXTURE_CUBE_POSITIVE_X : GL_TEXTURE_2D }
	{
