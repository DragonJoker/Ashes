...
namespace utils
{
	...
	*/
	...
	public:
		...
		*/
		inline renderer::UIVec2 size()const
		{
			return m_size;
		}
	...
	private:
		...
		*/
		virtual void onRestore( renderer::UIVec2 const & event ) = 0;
		/**
		*\brief
		*	Redimensionnement de la fenêtre.
		*/
		virtual void onResize( renderer::UIVec2 const & event ) = 0;
		/**
		*\brief
	...
	private:
		...
		void doDestroy();
		void doMinimise();
		void doRestore( renderer::UIVec2 const & size );
