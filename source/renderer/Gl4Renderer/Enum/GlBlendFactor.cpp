...
namespace ashes::gl4
{
	std::string getName( GlBlendFactor value )
	{
		switch ( value )
		{
		case GL_BLEND_FACTOR_ZERO:
			return "GL_ZERO";

		case GL_BLEND_FACTOR_ONE:
			return "GL_ONE";

		case GL_BLEND_FACTOR_SRC_COLOR:
			return "GL_SRC_COLOR";

		case GL_BLEND_FACTOR_ONE_MINUS_SRC_COLOR:
			return "GL_ONE_MINUS_SRC_COLOR";

		case GL_BLEND_FACTOR_SRC_ALPHA:
			return "GL_SRC_ALPHA";

		case GL_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA:
			return "GL_ONE_MINUS_SRC_ALPHA";

		case GL_BLEND_FACTOR_DST_ALPHA:
			return "GL_DST_ALPHA";

		case GL_BLEND_FACTOR_ONE_MINUS_DST_ALPHA:
			return "GL_ONE_MINUS_DST_ALPHA";

		case GL_BLEND_FACTOR_DST_COLOR:
			return "GL_DST_COLOR";

		case GL_BLEND_FACTOR_ONE_MINUS_DST_COLOR:
			return "GL_ONE_MINUS_DST_COLOR";

		case GL_BLEND_FACTOR_SRC_ALPHA_SATURATE:
			return "GL_SRC_ALPHA_SATURATE";

		case GL_BLEND_FACTOR_CONSTANT_COLOR:
			return "GL_CONSTANT_COLOR";

		case GL_BLEND_FACTOR_ONE_MINUS_CONSTANT_COLOR:
			return "GL_ONE_MINUS_CONSTANT_COLOR";

		case GL_BLEND_FACTOR_CONSTANT_ALPHA:
			return "GL_CONSTANT_ALPHA";

		case GL_BLEND_FACTOR_ONE_MINUS_CONSTANT_ALPHA:
			return "GL_ONE_MINUS_CONSTANT_ALPHA";

		case GL_BLEND_FACTOR_SRC1_ALPHA:
			return "GL_SRC1_ALPHA";

		case GL_BLEND_FACTOR_SRC1_COLOR:
			return "GL_SRC1_COLOR";

		case GL_BLEND_FACTOR_ONE_MINUS_SRC1_COLOR:
			return "GL_ONE_MINUS_SRC1_COLOR";

		case GL_BLEND_FACTOR_ONE_MINUS_SRC1_ALPHA:
