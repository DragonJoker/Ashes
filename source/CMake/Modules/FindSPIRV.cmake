	...
	IF ( SPIRV_FOUND )
		IF (MSVC)
			if ( SPIRV_LIBRARY_DEBUG )
				set( SPIRV_LIBRARIES optimized ${SPIRV_LIBRARY_RELEASE} debug ${SPIRV_LIBRARY_DEBUG} CACHE STRING "SPIRV libraries" )
				set( SPIRV_LIBRARY_DIRS ${SPIRV_LIBRARY_RELEASE_DIR} ${SPIRV_LIBRARY_DEBUG_DIR} )
			else()
				set( SPIRV_LIBRARIES ${SPIRV_LIBRARY_RELEASE} CACHE STRING "SPIRV libraries" )
