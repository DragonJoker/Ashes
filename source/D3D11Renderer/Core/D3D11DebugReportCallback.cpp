...
namespace ashes::d3d11
{
		...
		, ashes::Image const & image )const
	{
		static ReportData const baseReport
		{
			...
			ashes::DebugReportObjectType::eCommandBuffer,
			0u,
			0u,
			0u,
			"VALIDATION",
		...
		check( m_callback
			, report
			, ( ( imageType != ashes::ImageType::e1D && imageType != ashes::ImageType::e2D )
