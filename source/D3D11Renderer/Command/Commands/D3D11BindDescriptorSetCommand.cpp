...
namespace d3d11_renderer
{
	namespace
	{
		...
		template< ashes::ShaderStageFlag Flag, bool Supports11_1 >
		struct Binder;

		template<>
		struct Binder< ashes::ShaderStageFlag::eCompute, true >
		{
		...
		template<>
		struct Binder< ashes::ShaderStageFlag::eVertex, true >
		{
			static void bind( ID3D11DeviceContext1 * context, UINT bindingIndex, ID3D11ShaderResourceView * image, ID3D11SamplerState * sampler )
			{
				bind( context, bindingIndex, image );
		...
		template<>
		struct Binder< ashes::ShaderStageFlag::eGeometry, true >
		{
			static void bind( ID3D11DeviceContext1 * context, UINT bindingIndex, ID3D11ShaderResourceView * image, ID3D11SamplerState * sampler )
			{
				bind( context, bindingIndex, image );
		...
		template<>
		struct Binder< ashes::ShaderStageFlag::eTessellationControl, true >
		{
			static void bind( ID3D11DeviceContext1 * context, UINT bindingIndex, ID3D11ShaderResourceView * image, ID3D11SamplerState * sampler )
			{
				bind( context, bindingIndex, image );
		...
		template<>
		struct Binder< ashes::ShaderStageFlag::eTessellationEvaluation, true >
		{
			static void bind( ID3D11DeviceContext1 * context, UINT bindingIndex, ID3D11ShaderResourceView * image, ID3D11SamplerState * sampler )
			{
				bind( context, bindingIndex, image );
		...
		template<>
		struct Binder< ashes::ShaderStageFlag::eFragment, true >
		{
			static void bind( ID3D11DeviceContext1 * context, UINT bindingIndex, ID3D11ShaderResourceView * image, ID3D11SamplerState * sampler )
			{
				bind( context, bindingIndex, image );
		...
		template<>
		struct Binder< ashes::ShaderStageFlag::eVertex, false >
		{
			static void bind( ID3D11DeviceContext * context, UINT bindingIndex, ID3D11ShaderResourceView * image, ID3D11SamplerState * sampler )
			{
				bind( context, bindingIndex, image );
		...
		template<>
		struct Binder< ashes::ShaderStageFlag::eGeometry, false >
		{
			static void bind( ID3D11DeviceContext * context, UINT bindingIndex, ID3D11ShaderResourceView * image, ID3D11SamplerState * sampler )
			{
				bind( context, bindingIndex, image );
		...
		template<>
		struct Binder< ashes::ShaderStageFlag::eTessellationControl, false >
		{
			static void bind( ID3D11DeviceContext * context, UINT bindingIndex, ID3D11ShaderResourceView * image, ID3D11SamplerState * sampler )
			{
				bind( context, bindingIndex, image );
		...
		template<>
		struct Binder< ashes::ShaderStageFlag::eTessellationEvaluation, false >
		{
			static void bind( ID3D11DeviceContext * context, UINT bindingIndex, ID3D11ShaderResourceView * image, ID3D11SamplerState * sampler )
			{
				bind( context, bindingIndex, image );
		...
		template<>
		struct Binder< ashes::ShaderStageFlag::eFragment, false >
		{
			static void bind( ID3D11DeviceContext * context, UINT bindingIndex, ID3D11ShaderResourceView * image, ID3D11SamplerState * sampler )
			{
				bind( context, bindingIndex, image );
		...
		template< ashes::ShaderStageFlag Flag, bool Supports11_1, typename ... Params >
		...
		void tryBind( ID3D11DeviceContext1 * context
			...
			, Params ... params )
		{
			tryBindOne< ashes::ShaderStageFlag::eCompute, Supports11_1 >( context
				, bindingIndex
				, flags
				, params... );
			tryBindOne< ashes::ShaderStageFlag::eVertex, Supports11_1 >( context
				, bindingIndex
				, flags
				, params... );
			tryBindOne< ashes::ShaderStageFlag::eGeometry, Supports11_1 >( context
				, bindingIndex
				, flags
				, params... );
			tryBindOne< ashes::ShaderStageFlag::eTessellationControl, Supports11_1 >( context
				, bindingIndex
				, flags
				, params... );
			tryBindOne< ashes::ShaderStageFlag::eTessellationEvaluation, Supports11_1 >( context
				, bindingIndex
				, flags
				, params... );
			tryBindOne< ashes::ShaderStageFlag::eFragment, Supports11_1 >( context
				, bindingIndex
				, flags
				, params... );
		}
